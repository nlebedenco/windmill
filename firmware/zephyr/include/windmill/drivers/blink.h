...
#ifndef WINDMILL_DRIVERS_BLINK_H_
#define WINDMILL_DRIVERS_BLINK_H_
...
/**
 * Any header file that declares system calls must include a special generated header at the very bottom of the header
 * file. This header follows the naming convention syscalls/<name of header file>.
 */
...
#endif /* WINDMILL_DRIVERS_BLINK_H_ */
